...
public class UrlParamsBuilder {
    ...
    class ParamsMap {
        ...
        void put(String name, String value) {
            ...
            if (name == null || "".equals(name)) {
                throw new ZbException(SystemCode.RT_ERROR.getCode(), "[URL] Key can not be null");
            }
    ...
    private static String urlEncode(String s) {
        try {
            ...
            throw new ZbException(SystemCode.RT_ERROR.getCode(), "[URL] UTF-8 encoding not supported!");
        }
    }
}
